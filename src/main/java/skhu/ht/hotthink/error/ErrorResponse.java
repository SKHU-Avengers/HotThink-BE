...
public class ErrorResponse {
    ...
    public ErrorResponse(ErrorCode code, String customMsg) {
    ...
    public static ErrorResponse of(final ErrorCode code, String customMsg){
        return new ErrorResponse(code, customMsg);
    }
